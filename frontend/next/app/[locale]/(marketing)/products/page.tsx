...
export default async function Products(props: {
  ...
  return (
    <div className="relative overflow-hidden w-full">
      <ClientSlugHandler localizedSlugs={localizedSlugs || { [params.locale]: 'products' }} />
      <AmbientColor />
      <Container className="pt-40 pb-40">
        ...
        <Heading as="h1" className="pt-4">
          {productPage?.heading || 'Productos'}
        </Heading>
        <Subheading className="max-w-3xl mx-auto">
          {productPage?.sub_heading || 'Explora nuestros productos y novedades.'}
        </Subheading>
