  ...
  return (
    <Tag
      className={cn(
        ...
        'font-medium',
        // Light: texto oscuro sólido; Dark: gradiente existente
        'text-neutral-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-800 dark:via-white dark:to-white',
        sizeVariants[size],
        className
      )}
      {...props}
